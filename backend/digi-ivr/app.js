...
const body = {
  ...
  "sessionId": "cb72281842636d45d509dca52f58f94e"
    ...
    fetch("https://api-test2.ee.co.uk/common/geographicAddressManagement/v1/geographicAddress?postcode=SA5+2AG&addressSource=Openreach&isTechonologyMarkersRequired=true", {
      method: 'GET',
      headers: {
